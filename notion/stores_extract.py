...
VENUE_RULES = [
    ...
    ("バー・居酒屋・パブ", r"(?<!チョコレート)(?<!チョコ)(?<!ショコラ)(?<!レモン)(?<!ナッツ)(?<!トゥ・)(?<!トゥ)バー(?!ガー|ベキュー|ニャ|ジン)|居酒屋|パブ|酒場|立ち飲み|立呑|ビアカフェ|ビアホール|ブルーパブ|醸造所|ブルワリー|ワインバー|スナック|バール|酒蔵|地酒|タップルーム|ビアガーデン|ビール(?!煮)|ビアレストラン"),
