...
VENUE_RULES = [
    ...
    ("バー・居酒屋・パブ", r"(?:^|[\s、。（(「/／&＆]|ワイン|ビア|ビール|カクテル|ウイスキー|ウィスキー|フード|ダイニング|キッチン|スタンディング)バー(?![ムワントフジガベニ])|居酒屋|パブ|酒場|立ち飲み|立呑|ビアカフェ|ビアホール|ブラウンカフェ|ブルーパブ|醸造所|ブルワリー|ワインバー|スナック|バール|タップルーム|ビアガーデン|ビアレストラン"),
